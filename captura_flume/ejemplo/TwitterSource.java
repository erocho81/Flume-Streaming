...
public class TwitterSource extends AbstractSource
  ...
  public void configure(Context context) {
    ...
    System.out.println(ANSI_GREEN+"CONFIGURACION"+ANSI_RESET);
    System.out.println("***************************************");
  ...
  public void start() {
    ...
    try{
        ...
        //URIBuilder uriBuilder = new URIBuilder("https://api.twitter.com/2/tweets/recent?user.fields=name,username,location,public_metrics&expansions=author_id&tweet.fields=created_at,lang,public_metrics,referenced_tweets");
